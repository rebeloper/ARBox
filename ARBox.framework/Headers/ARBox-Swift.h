...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ARBox",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC5ARBox19ARBoxViewController")
@interface ARBoxViewController : UIViewController <SCNPhysicsContactDelegate>
- (void)viewDidLoad;
...
@interface ARBoxViewController (SWIFT_EXTENSION(ARBox)) <ARSCNViewDelegate>
...
SWIFT_CLASS("_TtC5ARBox14AnalogJoystick")
...
SWIFT_CLASS("_TtC5ARBox23AnalogJoystickComponent")
...
SWIFT_CLASS("_TtC5ARBox19AnalogJoystickStick")
@interface AnalogJoystickStick : AnalogJoystickComponent
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC5ARBox23AnalogJoystickSubstrate")
